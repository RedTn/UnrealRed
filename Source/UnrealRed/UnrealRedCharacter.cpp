...
AUnrealRedCharacter::AUnrealRedCharacter()
{
...
void AUnrealRedCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("TurnRate", this, &AUnrealRedCharacter::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &AUnrealRedCharacter::LookUpAtRate);
...
void AUnrealRedCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void AUnrealRedCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
...
void AUnrealRedCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUnrealRedCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void AUnrealRedCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
